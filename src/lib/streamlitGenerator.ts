/**
 * Generator for Streamlit Python Code and GitHub repository commands customized for Furqan
 */

export function generateStreamlitAppPy(developerName: string = "Furqan"): string {
...
st.markdown(f"### 🚀 **Developed by {developerName}**")
st.caption("AI-Powered Low-Resolution to 4K/8K Media Quality Enhancer & Batch Processor")

st.divider()

# =========================================================
# 🔑 API KEY & SECRETS CONFIGURATION (Beginner Friendly)
# =========================================================
# Streamlit Cloud reads keys automatically from st.secrets!
gemini_api_key = None
...
# Footer
st.markdown("---")
st.markdown(f"**ApexScale AI** • Built with Streamlit, Python & Gemini • **Developed by {developerName}**")
`;
}

export function generateStreamlitRequirementsTxt(): string {
...
export function generateStreamlitSecretsToml(): string {
  return `# .streamlit/secrets.toml
# For local testing, place this file inside a '.streamlit' folder.
# For Streamlit Community Cloud deployment, paste these lines into App Settings -> Secrets!

GEMINI_API_KEY = "YOUR_GEMINI_API_KEY_HERE"
DEVELOPER_NAME = "Furqan"
`;
}

export function generateGitHubGuideCommands(developerName: string = "Furqan"): string {
  const repoName = "apexscale-ai-upscaler";
  return `# 🚀 Streamlit Cloud & GitHub Deployment Guide for ${developerName}
...
# Step 2: Create a .gitignore file (Never commit secrets!)
...
git commit -m "ApexScale AI Ultra HD Upscaler Developed by ${developerName}"

# Step 5: Link to GitHub Repository (Replace YOUR_USERNAME with your GitHub username)
git branch -M main
...
# =========================================================
# PART 2: Deploy Free on Streamlit Community Cloud
# =========================================================

# Step 1: Go to https://share.streamlit.io and Sign In with GitHub
# Step 2: Click "New App" button
# Step 3: Select Repository: YOUR_USERNAME/${repoName}
# Step 4: Main file path: app.py
# Step 5: Click "Advanced Settings" -> "Secrets"
# Step 6: Paste your Gemini API Key in secrets box:
